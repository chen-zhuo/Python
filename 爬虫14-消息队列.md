...
# 连接局域网地址为192.168.1.112，端口为6379，密码为123456的机器上的Redis
# r = Redis.from_url("redis://:123456@192.168.1.112:6379", decode_responses=True)
...
message = r.rpoplpush('pending', 'processing')
