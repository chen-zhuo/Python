...
**AES是对称加密算法，接下来就要确定该算法的加密模式，在 `utils.js` 文件中我们找到了答案，当中 `CryptoJS.mode.ECB` 代码确定了加密模式位ECB加密模式，其中 `CryptoJS.pad.Pkcs7` 确定了填充方式是Pkcs7填充。**
...
**获得了加密密匙，结合[爬虫06-数据加密解密](爬虫06-数据加密解密.md)讲解的AES解密函数，就可以宣告成功该Js加密。**现在来逆向解密前面加密后的参数和返回的加密结果：
...
[初探js逆向（一）]([http://www.threetails.xyz/2019/05/10/%E5%88%9D%E6%8E%A2js%E9%80%86%E5%90%91/#more](http://www.threetails.xyz/2019/05/10/初探js逆向/#more))

[初探js逆向（二）]([http://www.threetails.xyz/2019/05/19/%E5%88%9D%E6%8E%A2js%E9%80%86%E5%90%91%EF%BC%88%E4%BA%8C%EF%BC%89/](http://www.threetails.xyz/2019/05/19/初探js逆向（二）/))
