...
**在爬虫的工作流程中，第2步特别重要，它其实就是对应的爬虫程序中的异常处理模块。**

在爬虫采集过程中有大量请求报错时，一定要让程序自动停掉，不然就变成了网络攻击。好多爬虫程序没有做异常逻辑下错误处理，导致多线程疯狂请求，惹来麻烦。本来正常的一次请求需求耗时500毫秒，万一对方网站服务器出错了，可能100毫秒就返回了，这样会导致爬虫程序的请求放大五倍，对方服务器更大的压力。还有访问超时也是，没做超时处理，尤其是长链接，你程序疯狂发请求，人家服务器刚好出问题，一直超时，你把人家的长链接全部占住，导致正常访问受阻。这样的后果非常危险！
