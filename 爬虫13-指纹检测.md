...
![640 (2)](image/640 (2).webp)

然后拿着接口直接请求，没问题，直接返回结果：

![640 (3)](image/640 (3).webp)

用requests上，果然有猫腻：

![640 (4)](image/640 (4).webp)

那就只有抓包看看了，当我打开fiddler抓包时，再次运行程序，数据居然出来了：

![640 (5)](image/640 (5).webp)

但当我把fiddler一关，再次请求，又不行了：

![640 (6)](image/640 (6).webp)
...
![640 (16)](image/640 (16).webp)

看ja3指纹的对比就知道，差太多了：

![640 (17)](image/640 (17).webp)
...
![640 (20)](image/640 (20).webp)

一执行，发现，可行了：

![640 (19)](image/640 (19).webp)
